...
public class MainActivity extends AppCompatActivity {
    ...
    public void  btnAbrirPaginaWebClick    ( View v ) {
        layout      = getLayoutInflater().inflate ( R.layout.layout_edit_text_simple, null );
        edtTexto  = layout.findViewById  ( R.id.edtTexto );
        edtTexto.setText ( "http://www.itlalaguna.edu.mx/" );
        ...
        builder.setTitle ( "Texto a enviar:" )
                ...
                .setPositiveButton("Enviar", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        intent.putExtra ( Intent.EXTRA_EMAIL, new String [] { "josearg150@gmail.com" } );
                        intent.putExtra ( Intent.EXTRA_CC,    new String [] { "alu.18131273@correo.itlalaguna.edu.com"     } );
                        intent.putExtra ( Intent.EXTRA_SUBJECT, "Probando correo"  );
