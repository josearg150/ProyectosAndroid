...
public class MainActivity extends AppCompatActivity {
    ...
    protected static final String ACTIVITY_REQUEST_CODE ="mx.itl.edu.c16131300.u3paseargumentosapp..MainActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // se registra un nuevo lanzador de ActivityForResult
        activityLauncher = registerForActivityResult (
                new ActivityResultContracts.StartActivityForResult (),
                new ActivityResultCallback<ActivityResult>() {
                    @Override
                    public void onActivityResult ( ActivityResult result ) {
                    // cuando se retorne del Intent lanzado se delega la accion a this.onActivityResult ()
